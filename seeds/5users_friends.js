  ...
  return knex('users_friends').del()
    .then(() => {
      return Promise.all([
        ...
        knex('users_friends').insert({user_id: 5, friend_id: 3, friend_firstname: 'Brendan', profile_url: 'https://s3-us-west-2.amazonaws.com/divideyourself.com/images/1divide-logo.svg'}),
        ...
        knex('users_friends').insert({user_id: 4, friend_id: 1, friend_firstname: 'Ryan', profile_url: 'https://s3-us-west-2.amazonaws.com/divideyourself.com/images/1divide-logo.svg'}),
        knex('users_friends').insert({user_id: 1, friend_id: 4, friend_firstname: 'Nathan', profile_url: 'https://s3-us-west-2.amazonaws.com/divideyourself.com/images/1divide-logo.svg'}),
        knex('users_friends').insert({user_id: 4, friend_id: 3, friend_firstname: 'Brendan', profile_url: 'https://s3-us-west-2.amazonaws.com/divideyourself.com/images/1divide-logo.svg'}),
        knex('users_friends').insert({user_id: 3, friend_id: 4, friend_firstname: 'Nathan', profile_url: 'https://s3-us-west-2.amazonaws.com/divideyourself.com/images/1divide-logo.svg'}),
      ]);
    });
};
